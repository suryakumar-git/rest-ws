...
import com.developer.ws.ui.model.request.PasswordResetModel;
import com.developer.ws.ui.model.request.PasswordResetRequestModel;
import com.developer.ws.ui.model.request.UserDetailsRequestModel;
import com.developer.ws.ui.model.response.AddressRest;
import com.developer.ws.ui.model.response.ErrorMessages;
import com.developer.ws.ui.model.response.OperationStatusModel;
import com.developer.ws.ui.model.response.RequestOperationName;
import com.developer.ws.ui.model.response.RequestOperationStatus;
...
public class UserController {
	...
	// http://localhost:8080/rest-ws/users/{user_id}/addresses
	...
	// http://localhost:8080/rest-ws/users/{user_id}/addresses/{address_id}
	...
	// http://localhost:8080/rest-ws/users/email-verification?token=opuiuggfvbv
	...
	// http://localhost:8080/rest-ws/users/password-reset-request
	@PostMapping(path = "/password-reset-request", consumes = { MediaType.APPLICATION_JSON_VALUE,
			MediaType.APPLICATION_XML_VALUE }, produces = { MediaType.APPLICATION_XML_VALUE,
					MediaType.APPLICATION_JSON_VALUE })
	public OperationStatusModel requestReset(@RequestBody PasswordResetRequestModel passwordResetRequestDetails)
			throws Exception {

		OperationStatusModel returnValue = new OperationStatusModel();
		boolean operationResult = userService.requestPasswordReset(passwordResetRequestDetails.getEmail());
	...
	// http://localhost:8080/rest-ws/users/password-reset
	...
	// http://localhost:8080/rest-ws/users/<userid>
