...
public class EmailConfiguration {
	...
	/*
	 * @Bean public SpringTemplateEngine thymeleafTemplateEngine(ITemplateResolver
	 ...
	 * templateEngine; }
	 * 
	 * @Bean public ITemplateResolver thymeleafClassLoaderTemplateResolver() {
	 * ClassLoaderTemplateResolver templateResolver = new
	 * ClassLoaderTemplateResolver(); templateResolver.setPrefix(mailTemplatesPath +
...
//    }
	 ...
	 * Configuration(Configuration.VERSION_2_3_27); TemplateLoader templateLoader =
	 * new ClassTemplateLoader(this.getClass(), "/" + mailTemplatesPath);
	 * configuration.setTemplateLoader(templateLoader); FreeMarkerConfigurer
	 * freeMarkerConfigurer = new FreeMarkerConfigurer();
	 * freeMarkerConfigurer.setConfiguration(configuration); return
